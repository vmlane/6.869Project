...
\caption{Comparing all 4 algorithm variations on the Venus test image.  Top: one frame of the original test images; ground truth flow.  Middle: HS; HS with multi-resolution optimization.  Bottom: Charbonnier; Charbonnier with multi-resolution optimization.  Using a multi-resolution pyramid helps the algorithm discover large areas of high-magnitude flow, while the Charbonnier penalty makes edges somewhat better-defined.}
\label{fig:venus}
\end{figure}
